    ...
    return (
      <section className={`${s.root} mb-4`}>
        <h1 className="page-title">
          UI - <span className="fw-semi-bold">Icons</span>
        </h1>
        ...
        <Nav className="bg-transparent" tabs>
          ...
          <NavItem>
            ...
            >
              ...
              <Badge color="primary" style={{ padding: "3px 8px" }}>
                new
              </Badge>
            </NavLink>
          </NavItem>
        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            <div>
              <h4>
                Built-in <span className="fw-semi-bold">Glyphicons</span>
              </h4>
          ...
          <TabPane tabId="2">
            <div>
              <h4>
                Awesome <span className="fw-semi-bold">Font Awesome</span>
              </h4>
              <Row className="icon-list">
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/bed">
                    <i className="fa fa-bed" /> bed
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/university">
                    <i className="fa fa-bank" /> bank{" "}
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/behance-square">
                    <i className="fa fa-behance-square" /> behance-square
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/bomb">
                    <i className="fa fa-bomb" /> bomb
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/building">
                    <i className="fa fa-building" /> building
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/taxi">
                    <i className="fa fa-cab" /> cab{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/car">
                    <i className="fa fa-car" /> car
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/child">
                    <i className="fa fa-child" /> child
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/circle-o-notch">
                    <i className="fa fa-circle-o-notch" /> circle-o-notch
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/circle-thin">
                    <i className="fa fa-circle-thin" /> circle-thin
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/cube">
                    <i className="fa fa-cube" /> cube
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/cubes">
                    <i className="fa fa-cubes" /> cubes
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/delicious">
                    <i className="fa fa-delicious" /> delicious
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/deviantart">
                    <i className="fa fa-deviantart" /> deviantart
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/digg">
                    <i className="fa fa-digg" /> digg
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/drupal">
                    <i className="fa fa-drupal" /> drupal
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/empire">
                    <i className="fa fa-empire" /> empire
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-archive-o">
                    <i className="fa fa-file-archive-o" /> file-archive-o
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-code-o">
                    <i className="fa fa-file-code-o" /> file-code-o
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-video-o">
                    <i className="fa fa-file-movie-o" /> file-movie-o{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-pdf-o">
                    <i className="fa fa-file-pdf-o" /> file-pdf-o
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-image-o">
                    <i className="fa fa-file-photo-o" /> file-photo-o{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-audio-o">
                    <i className="fa fa-file-sound-o" /> file-sound-o{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-word-o">
                    <i className="fa fa-file-word-o" /> file-word-o
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/file-archive-o">
                    <i className="fa fa-file-zip-o" /> file-zip-o{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/git-square">
                    <i className="fa fa-git-square" /> git-square
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/graduation-cap">
                    <i className="fa fa-graduation-cap" /> graduation-cap
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/hacker-news">
                    <i className="fa fa-hacker-news" /> hacker-news
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/header">
                    <i className="fa fa-header" /> header
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/university">
                    <i className="fa fa-institution" /> institution{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/joomla">
                    <i className="fa fa-joomla" /> joomla
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/jsfiddle">
                    <i className="fa fa-jsfiddle" /> jsfiddle
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/life-ring">
                    <i className="fa fa-life-bouy" /> life-bouy{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/life-ring">
                    <i className="fa fa-life-ring" /> life-ring
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/life-ring">
                    <i className="fa fa-life-saver" /> life-saver{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/openid">
                    <i className="fa fa-openid" /> openid
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/paper-plane">
                    <i className="fa fa-paper-plane" /> paper-plane
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/paragraph">
                    <i className="fa fa-paragraph" /> paragraph
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/paw">
                    <i className="fa fa-paw" /> paw
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/pied-piper">
                    <i className="fa fa-pied-piper" /> pied-piper
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/pied-piper-alt">
                    <i className="fa fa-pied-piper-alt" /> pied-piper-alt
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/qq">
                    <i className="fa fa-qq" /> qq
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/rebel">
                    <i className="fa fa-ra" /> ra{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/rebel">
                    <i className="fa fa-rebel" /> rebel
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/recycle">
                    <i className="fa fa-recycle" /> recycle
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/paper-plane-o">
                    <i className="fa fa-send-o" /> send-o{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/share-alt">
                    <i className="fa fa-share-alt" /> share-alt
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/sliders">
                    <i className="fa fa-sliders" /> sliders
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/soundcloud">
                    <i className="fa fa-soundcloud" /> soundcloud
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/stumbleupon">
                    <i className="fa fa-stumbleupon" /> stumbleupon
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/university">
                    <i className="fa fa-university" /> university
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/vine">
                    <i className="fa fa-vine" /> vine
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/weixin">
                    <i className="fa fa-wechat" /> wechat{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/weixin">
                    <i className="fa fa-weixin" /> weixin
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/wordpress">
                    <i className="fa fa-wordpress" /> wordpress
                  </a>
                </Col>

                <Col lg={3} md={4} xs={12} className="icon-list-item">
                  <a href="../icon/yahoo">
                    <i className="fa fa-yahoo" /> yahoo
                  </a>
                </Col>
              </Row>
            </div>
            ...
            <div>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/adjust">
                    <i className="fa fa-adjust" /> adjust
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/arrows">
                    <i className="fa fa-arrows" /> arrows
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/arrows-h">
                    <i className="fa fa-arrows-h" /> arrows-h
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/arrows-v">
                    <i className="fa fa-arrows-v" /> arrows-v
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/car">
                    <i className="fa fa-automobile" /> automobile{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bar-chart-o">
                    <i className="fa fa-bar-chart-o" /> bar-chart-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bell">
                    <i className="fa fa-bell" /> bell
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bell-o">
                    <i className="fa fa-bell-o" /> bell-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bolt">
                    <i className="fa fa-bolt" /> bolt
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bookmark-o">
                    <i className="fa fa-bookmark-o" /> bookmark-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/briefcase">
                    <i className="fa fa-briefcase" /> briefcase
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/building-o">
                    <i className="fa fa-building-o" /> building-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bullhorn">
                    <i className="fa fa-bullhorn" /> bullhorn
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bullseye">
                    <i className="fa fa-bullseye" /> bullseye
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/calendar-o">
                    <i className="fa fa-calendar-o" /> calendar-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/check-circle-o">
                    <i className="fa fa-check-circle-o" /> check-circle-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/check-square-o">
                    <i className="fa fa-check-square-o" /> check-square-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/circle-o">
                    <i className="fa fa-circle-o" /> circle-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/clock-o">
                    <i className="fa fa-clock-o" /> clock-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/cloud-download">
                    <i className="fa fa-cloud-download" /> cloud-download
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/code-fork">
                    <i className="fa fa-code-fork" /> code-fork
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/cog">
                    <i className="fa fa-cog" /> cog
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/cogs">
                    <i className="fa fa-cogs" /> cogs
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/comment-o">
                    <i className="fa fa-comment-o" /> comment-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/comments-o">
                    <i className="fa fa-comments-o" /> comments-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/compass">
                    <i className="fa fa-compass" /> compass
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/crosshairs">
                    <i className="fa fa-crosshairs" /> crosshairs
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/cutlery">
                    <i className="fa fa-cutlery" /> cutlery
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/ellipsis-h">
                    <i className="fa fa-ellipsis-h" /> ellipsis-h
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/ellipsis-v">
                    <i className="fa fa-ellipsis-v" /> ellipsis-v
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/envelope-o">
                    <i className="fa fa-envelope-o" /> envelope-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/exchange">
                    <i className="fa fa-exchange" /> exchange
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/exclamation">
                    <i className="fa fa-exclamation" /> exclamation
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/eye-slash">
                    <i className="fa fa-eye-slash" /> eye-slash
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/fighter-jet">
                    <i className="fa fa-fighter-jet" /> fighter-jet
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/flag-checkered">
                    <i className="fa fa-flag-checkered" /> flag-checkered
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/flag-o">
                    <i className="fa fa-flag-o" /> flag-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bolt">
                    <i className="fa fa-flash" /> flash{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/folder-o">
                    <i className="fa fa-folder-o" /> folder-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/folder-open">
                    <i className="fa fa-folder-open" /> folder-open
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/frown-o">
                    <i className="fa fa-frown-o" /> frown-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/gamepad">
                    <i className="fa fa-gamepad" /> gamepad
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/gavel">
                    <i className="fa fa-gavel" /> gavel
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/cog">
                    <i className="fa fa-gear" /> gear{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/glass">
                    <i className="fa fa-glass" /> glass
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/globe">
                    <i className="fa fa-globe" /> globe
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/hdd-o">
                    <i className="fa fa-hdd-o" /> hdd-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/headphones">
                    <i className="fa fa-headphones" /> headphones
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/heart-o">
                    <i className="fa fa-heart-o" /> heart-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/info-circle">
                    <i className="fa fa-info-circle" /> info-circle
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/keyboard-o">
                    <i className="fa fa-keyboard-o" /> keyboard-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/laptop">
                    <i className="fa fa-laptop" /> laptop
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/leaf">
                    <i className="fa fa-leaf" /> leaf
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/gavel">
                    <i className="fa fa-legal" /> legal{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/lemon-o">
                    <i className="fa fa-lemon-o" /> lemon-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/level-down">
                    <i className="fa fa-level-down" /> level-down
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/level-up">
                    <i className="fa fa-level-up" /> level-up
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/lightbulb-o">
                    <i className="fa fa-lightbulb-o" /> lightbulb-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/location-arrow">
                    <i className="fa fa-location-arrow" /> location-arrow
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/magic">
                    <i className="fa fa-magic" /> magic
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/magnet">
                    <i className="fa fa-magnet" /> magnet
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/share">
                    <i className="fa fa-mail-forward" /> mail-forward{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/reply">
                    <i className="fa fa-mail-reply" /> mail-reply{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/reply-all">
                    <i className="fa fa-mail-reply-all" /> mail-reply-all{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/minus-square-o">
                    <i className="fa fa-minus-square-o" /> minus-square-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/mobile">
                    <i className="fa fa-mobile-phone" /> mobile-phone{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/money">
                    <i className="fa fa-money" /> money
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/moon-o">
                    <i className="fa fa-moon-o" /> moon-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bars">
                    <i className="fa fa-navicon" /> navicon{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/picture-o">
                    <i className="fa fa-picture-o" /> picture-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/plane">
                    <i className="fa fa-plane" /> plane
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/plus-circle">
                    <i className="fa fa-plus-circle" /> plus-circle
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/plus-square">
                    <i className="fa fa-plus-square" /> plus-square
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/power-off">
                    <i className="fa fa-power-off" /> power-off
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/qrcode">
                    <i className="fa fa-qrcode" /> qrcode
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/question">
                    <i className="fa fa-question" /> question
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/quote-left">
                    <i className="fa fa-quote-left" /> quote-left
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/quote-right">
                    <i className="fa fa-quote-right" /> quote-right
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/bars">
                    <i className="fa fa-reorder" /> reorder{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/retweet">
                    <i className="fa fa-retweet" /> retweet
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/road">
                    <i className="fa fa-road" /> road
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/rocket">
                    <i className="fa fa-rocket" /> rocket
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/rss-square">
                    <i className="fa fa-rss-square" /> rss-square
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/search-plus">
                    <i className="fa fa-search-plus" /> search-plus
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/share-square-o">
                    <i className="fa fa-share-square-o" /> share-square-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/shield">
                    <i className="fa fa-shield" /> shield
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/signal">
                    <i className="fa fa-signal" /> signal
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sitemap">
                    <i className="fa fa-sitemap" /> sitemap
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/smile-o">
                    <i className="fa fa-smile-o" /> smile-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort-alpha-asc">
                    <i className="fa fa-sort-alpha-asc" /> sort-alpha-asc
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort-asc">
                    <i className="fa fa-sort-asc" /> sort-asc
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort-desc">
                    <i className="fa fa-sort-desc" /> sort-desc
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort-desc">
                    <i className="fa fa-sort-down" /> sort-down{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort-asc">
                    <i className="fa fa-sort-up" /> sort-up{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/square-o">
                    <i className="fa fa-square-o" /> square-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/star-half">
                    <i className="fa fa-star-half" /> star-half
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/star-half-o">
                    <i className="fa fa-star-half-empty" /> star-half-empty{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/star-half-o">
                    <i className="fa fa-star-half-full" /> star-half-full{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/star-half-o">
                    <i className="fa fa-star-half-o" /> star-half-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/star-o">
                    <i className="fa fa-star-o" /> star-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/suitcase">
                    <i className="fa fa-suitcase" /> suitcase
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sun-o">
                    <i className="fa fa-sun-o" /> sun-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/tablet">
                    <i className="fa fa-tablet" /> tablet
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/tachometer">
                    <i className="fa fa-tachometer" /> tachometer
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/thumb-tack">
                    <i className="fa fa-thumb-tack" /> thumb-tack
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/thumbs-down">
                    <i className="fa fa-thumbs-down" /> thumbs-down
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/thumbs-o-up">
                    <i className="fa fa-thumbs-o-up" /> thumbs-o-up
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/thumbs-up">
                    <i className="fa fa-thumbs-up" /> thumbs-up
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/times-circle-o">
                    <i className="fa fa-times-circle-o" /> times-circle-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/tint">
                    <i className="fa fa-tint" /> tint
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/caret-square-o-up">
                    <i className="fa fa-toggle-up" /> toggle-up{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/trash-o">
                    <i className="fa fa-trash-o" /> trash-o
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/trophy">
                    <i className="fa fa-trophy" /> trophy
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/umbrella">
                    <i className="fa fa-umbrella" /> umbrella
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/unlock-alt">
                    <i className="fa fa-unlock-alt" /> unlock-alt
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/sort">
                    <i className="fa fa-unsorted" /> unsorted{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/volume-down">
                    <i className="fa fa-volume-down" /> volume-down
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/volume-off">
                    <i className="fa fa-volume-off" /> volume-off
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/volume-up">
                    <i className="fa fa-volume-up" /> volume-up
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/wheelchair">
                    <i className="fa fa-wheelchair" /> wheelchair
                  </a>
                </Col>
              ...
              <Row className="icon-list">
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/align-left">
                    <i className="fa fa-align-left" /> align-left
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/align-right">
                    <i className="fa fa-align-right" /> align-right
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/outdent">
                    <i className="fa fa-dedent" /> dedent{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/file-o">
                    <i className="fa fa-file-o" /> file-o
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/file-text">
                    <i className="fa fa-file-text" /> file-text
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/file-text-o">
                    <i className="fa fa-file-text-o" /> file-text-o
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/files-o">
                    <i className="fa fa-files-o" /> files-o
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/floppy-o">
                    <i className="fa fa-floppy-o" /> floppy-o
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/font">
                    <i className="fa fa-font" /> font
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/indent">
                    <i className="fa fa-indent" /> indent
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/list-alt">
                    <i className="fa fa-list-alt" /> list-alt
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/list-ol">
                    <i className="fa fa-list-ol" /> list-ol
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/list-ul">
                    <i className="fa fa-list-ul" /> list-ul
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/outdent">
                    <i className="fa fa-outdent" /> outdent
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/paperclip">
                    <i className="fa fa-paperclip" /> paperclip
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/scissors">
                    <i className="fa fa-scissors" /> scissors
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/subscript">
                    <i className="fa fa-subscript" /> subscript
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/superscript">
                    <i className="fa fa-superscript" /> superscript
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/text-height">
                    <i className="fa fa-text-height" /> text-height
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/text-width">
                    <i className="fa fa-text-width" /> text-width
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/th">
                    <i className="fa fa-th" /> th
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/th-large">
                    <i className="fa fa-th-large" /> th-large
                  </a>
                </Col>

                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/th-list">
                    <i className="fa fa-th-list" /> th-list
                  </a>
                </Col>
                ...
                <Col md={4} lg={3} xs={12} className="icon-list-item">
                  <a href="../icon/chain-broken">
                    <i className="fa fa-unlink" /> unlink{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
              </Row>
          ...
          <TabPane tabId="6">
            <div>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/adn">
                    <i className="fa fa-adn" /> adn
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/android">
                    <i className="fa fa-android" /> android
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/btc">
                    <i className="fa fa-bitcoin" /> bitcoin{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/foursquare">
                    <i className="fa fa-foursquare" /> foursquare
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/github-alt">
                    <i className="fa fa-github-alt" /> github-alt
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/gittip">
                    <i className="fa fa-gittip" /> gittip
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/maxcdn">
                    <i className="fa fa-maxcdn" /> maxcdn
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/pagelines">
                    <i className="fa fa-pagelines" /> pagelines
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/renren">
                    <i className="fa fa-renren" /> renren
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/stack-exchange">
                    <i className="fa fa-stack-exchange" /> stack-exchange
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/twitter-square">
                    <i className="fa fa-twitter-square" /> twitter-square
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/xing">
                    <i className="fa fa-xing" /> xing
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/xing-square">
                    <i className="fa fa-xing-square" /> xing-square
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/youtube-square">
                    <i className="fa fa-youtube-square" /> youtube-square
                  </a>
                </Col>
              </Row>
            </div>
          ...
          <TabPane tabId="7">
            <div>
              <h4>
                File Type <span className="fw-semi-bold">Icons</span>
              </h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/file">
              ...
              <h4>
                Form Control <span className="fw-semi-bold">Icons</span>
              </h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/check-square">
              ...
              <h4>
                Currency <span className="fw-semi-bold">Icons</span>
              </h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/btc">
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/usd">
                    <i className="fa fa-dollar" /> dollar{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/gbp">
                    <i className="fa fa-gbp" /> gbp
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/inr">
                    <i className="fa fa-inr" /> inr
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/jpy">
                    <i className="fa fa-jpy" /> jpy
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/krw">
                    <i className="fa fa-krw" /> krw
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/rub">
                    <i className="fa fa-rouble" /> rouble{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/rub">
                    <i className="fa fa-rub" /> rub
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/rub">
                    <i className="fa fa-ruble" /> ruble{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/try">
                    <i className="fa fa-try" /> try
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/try">
                    <i className="fa fa-turkish-lira" /> turkish-lira{" "}
                    <span className="text-muted">(alias)</span>
                  </a>
                </Col>
              ...
              <h4>
                Video Player <span className="fw-semi-bold">Icons</span>
              </h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/arrows-alt">
                    <i className="fa fa-arrows-alt" /> arrows-alt
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/compress">
                    <i className="fa fa-compress" /> compress
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/eject">
                    <i className="fa fa-eject" /> eject
                  </a>
                </Col>
              ...
              <h4>
                Medical <span className="fw-semi-bold">Icons</span>
              </h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/ambulance">
                    <i className="fa fa-ambulance" /> ambulance
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/h-square">
                    <i className="fa fa-h-square" /> h-square
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/hospital-o">
                    <i className="fa fa-hospital-o" /> hospital-o
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/medkit">
                    <i className="fa fa-medkit" /> medkit
                  </a>
                </Col>
                ...
                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/stethoscope">
                    <i className="fa fa-stethoscope" /> stethoscope
                  </a>
                </Col>

                <Col className="icon-list-item" lg={3} md={4} xs={12}>
                  <a href="../icon/user-md">
                    <i className="fa fa-user-md" /> user-md
                  </a>
                </Col>
